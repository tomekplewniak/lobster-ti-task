...
namespace LevelUp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220927182052_AddNextQuestion")]
    partial class AddNextQuestion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LevelUp.Domain.Entities.QuestionOptionEntity", b =>
                {
                    ...
                    b.HasIndex("NextQuestionId")
                        .HasDatabaseName("ix_question_options_next_question_id");
            ...
            modelBuilder.Entity("LevelUp.Domain.Entities.QuestionOptionEntity", b =>
                {
                    b.HasOne("LevelUp.Domain.Entities.QuestionEntity", "NextQuestion")
                        .WithMany()
                        .HasForeignKey("NextQuestionId")
                        .HasConstraintName("fk_question_options_questions_next_question_id");
